<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Default2" %>
        ...
        <div class="container py-md-5 py-4">
            <div class="row">
                <div
                    ...
                    <img src="src/images1/about1.jpg" alt="" class="img-fluid">
                    <img src="src/images1/about2.jpg" alt=""
                ...
                <div class="col-lg-6 about-right-faq align-self pl-lg-5 mt-xl-4 order-lg-last order-first">
                    ...
                    <img class="img-fluid mt-md-5 mt-4 img-dark-color" src="src/images1/sign.png" alt=" ">
                </div>
            </div>
        </div>
    </section>
