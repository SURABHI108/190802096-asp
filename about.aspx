<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true" CodeFile="about.aspx.cs" Inherits="Default2" %>
        ...
        <div class="container pt-md-5 pt-4">
            <div class="row">
                <div class="col-lg-5 w3l-features-6-left order-lg-first order-last text-center">
                    <img src="src/images1/img1.png" class="img-fluid" alt="" />
                </div>
        ...
        <div class="container py-md-5 py-4">
            ...
            <div class="row team-row pt-lg-3">
                <div class="col-lg-3 col-sm-6 team-wrap">
                    <div class="team-info">
                        <div class="column position-relative img-circle">
                            <a href="#url"><img src="src/images1/team1.jpg" alt="" class="img-fluid team-image" /></a>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 team-wrap mt-sm-0 pt-sm-0 mt-4 pt-2">
                    <div class="team-info">
                        <div class="column position-relative img-circle">
                            <a href="#url"><img src="src/images1/team3.jpg" alt="" class="img-fluid team-image" /></a>
                        </div>
                        <div class="column-btm">
                ...
                <div class="col-lg-3 col-sm-6 team-wrap mt-lg-0 pt-lg-0 mt-4 pt-2">
                    <div class="team-info">
                        <div class="column position-relative img-circle">
                            <a href="#url"><img src="src/images1/team2.jpg" alt="" class="img-fluid team-image" /></a>
                        </div>
                        <div class="column-btm">
                ...
                <div class="col-lg-3 col-sm-6 team-wrap mt-lg-0 pt-lg-0 mt-4 pt-2">
                    <div class="team-info">
                        <div class="column position-relative img-circle">
                            <a href="#url"><img src="src/images1/team4.jpg" alt="" class="img-fluid team-image" /></a>
                        </div>
                        <div class="column-btm">
                ...
                <div class="item col-md-6 pl-md-0">
                    <div class="testimonial-content">
                        ...
                        <div class="bottom-info mt-4">
                            ...
                            <a class="comment-img mt-3" href="#url"><img src="src/images1/testi1.jpg"
                ...
                <div class="item col-md-6 pl-md-0 mt-md-0 mt-sm-5 mt-4">
                    <div class="testimonial-content">
                        ...
                        <div class="bottom-info mt-4">
                            ...
                            <a class="comment-img mt-3" href="#url"><img src="src/images1/testi2.jpg"
                                    class="img-responsive" alt="placeholder image"></a>
                        </div>
                    </div>
                </div>
